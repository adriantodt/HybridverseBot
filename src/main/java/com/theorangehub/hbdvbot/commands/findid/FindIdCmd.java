...
import com.theorangehub.hbdvbot.commands.findid.helpers.AtribGen;
import com.theorangehub.hbdvbot.commands.findid.helpers.FindIdTask;
import com.theorangehub.hbdvbot.commands.findid.helpers.FindIdTaskResult;
...
@Command("findid")
public class FindIdCmd extends SimpleCommand {
